...
def MainMenu():
	addDir('[COLOR gold]Instalar Wizard Jungle-Team [/COLOR]','',1,addon_icon,addon_fanart,local_string(30001),isFolder=True)
...
def main(NAME, NAME2, VERSION, URL, ICON, FANART, DESCRIPTION):
	...
	yesInstall = dialog.yesno(NAME, 'Vamos a proceder a instalar el Wizard Jungle-Team', nolabel='Cancelar', yeslabel='Continuar')
	if yesInstall:
	    save_check()
	    save_move1()
