...
def MainMenu():
	addDir('[COLOR gold]Instalar Wizard Palantir 2 Matrix [/COLOR]','',1,addon_icon,addon_fanart,local_string(30001),isFolder=True)
...
def main(NAME, NAME2, VERSION, URL, ICON, FANART, DESCRIPTION):
	...
	yesInstall = dialog.yesno(NAME, 'Voy a instalar el Wizar Palantir 2 para Matrix', nolabel='Cancelar', yeslabel='Continuar')
	if yesInstall:
	    save_check()
	    save_move1()
	    yesFresh = dialog.yesno('Borrar TODO', 'Recomendado borrar todo antes de instalar el Wizard', nolabel='No', yeslabel='Borrar')
	    if yesFresh:
	    	freshStart()
